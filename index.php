...
<head>
    ...
    <title>Sistem Pelayanan Surat Online  Dinas Sosial Kota Tanjuungpinang</title>
    <!-- core CSS -->
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="main/img/Dinsos.png" width="40" height="54" alt="logo"></a>
                </div>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>SISTEM PELAYANAN</span> SURAT ONLINE <br> DINAS SOSIAL KOTA TANJUNGPINANG</h2>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh kepala dinas sosial kota tanjungpinang, kemudian staf akan mencetak surat sesuai request surat yang diajukan, pemohon mengambil surat yang sudah dicetak dan bertandatangan di Kantor Kelurahan Wergu Wetan.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <section id="contact">
        <div>
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2820.865148019559!2d104.51249257299557!3d0.9184224184660001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31d96dc5073da553%3A0xc6526c31baf8b3c3!2sDinas%20Sosial%20Kota%20Tanjungpinang!5e0!3m2!1sid!2sid!4v1667570759510!5m2!1sid!2sid" width="100%" height="650px" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" alt="lokasi dinas sosial kota tanjungpinang"></iframe>
        </div>
    </section>
    <!--/#bottom-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y');?> SISTEM PELAYANAN SURAT ONLINE - DINSOS
                </div>
                <div class="col-sm-6">
